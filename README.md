...
> Para una lista completa de bibliotecas utilizadas en el script, consulta la sección correspondiente en el archivo [`RELEASE.md`](https://github.com/Rodri082/ManagerOfficeScriptTool/releases/latest).
